...
game = 20787
csv_filename = str(game)  + '_opposition_sva.csv'
the_table = str(game) + '_opposition_sva'
url = "https://www.naturalstattrick.com/game.php?season=20232024&game=" + str(game)
...
#tables = soup.find('table', id="toCOL11s")
#print(tables)
df = pd.read_html(StringIO(str(url)))
print(df)
