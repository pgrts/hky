...
new_df = get_games_df(yesterday)[['gameid', 'awayTeam', 'homeTeam']]
#create_shift_chart('2023021006').to_csv('psps.csv')
g=0
times = ['startTime','endTime']
...
while g < len(new_df.index):
    ...
    #shiftdf.plot()
    g+=1
#shiftdf.plot(kind = 'barh')
    shiftdf.to_csv('sfdsdfd.csv', mode = 'a')
