...
one_5v5sva_on_ice_relative_opps = \
"https://www.naturalstattrick.com/playerreport.php?fromseason=20232024&thruseason=20232024&stype=2&sit=sva&stdoi=oi&rate=r&v=o&playerid="
one_PK_on_ice_relative_opps = \
"https://www.naturalstattrick.com/playerreport.php?fromseason=20232024&thruseason=20232024&stype=2&sit=4v5&stdoi=oi&rate=r&v=o&playerid="
one_PP_on_ice_relative_opps = \
"https://www.naturalstattrick.com/playerreport.php?fromseason=20232024&thruseason=20232024&stype=2&sit=5v4&stdoi=oi&rate=r&v=o&playerid="                                
...
for ind in df.index:
    ...
    teammates_filename = player + "_5v5sva_opps.csv"
    full_url = one_5v5sva_on_ice_relative_opps + player
    df2 = pd.read_html(full_url, header=0, index_col = 0, na_values=[""])[0]
    df2.to_csv(teammates_filename)

    time.sleep(5)
    
    teammates_pk_url = one_PK_on_ice_relative_opps + player
    teammates_pk_filename = player + "_PKsva_opps.csv"
    df3 = pd.read_html(teammates_pk_url, header=0, index_col = 0, na_values=[""])[0]
    df3.to_csv(teammates_pk_filename)

    time.sleep(5)

    teammates_pp_url = one_PP_on_ice_relative_opps + player
    teammates_pp_filename = player + "_PPsva_opps.csv"
